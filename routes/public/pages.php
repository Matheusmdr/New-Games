...
$obRouter->post('/', [
    function ($request) {
        return new Response(200, Pages\Home::setWishlist($request));
    }
]);
...
$obRouter->get('/checkout', [
    ...
    function ($request) {
        return new Response(200, Pages\orderConfirmation::getOrderConfirmation($request));
    }
]);


$obRouter->post('/checkout', [
    'middlewares' => [
        'required-client-login',
        'required-products-in-cart'
    ],
    function ($request) {
        return new Response(200, Pages\orderConfirmation::setOrder($request));
    }
]);
